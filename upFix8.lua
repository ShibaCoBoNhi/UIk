...
function DragonLib:Notify(NotifyConfig)
    ...
    NotifyConfig.Title = NotifyConfig.Title or "DragonToro Hub"
...
function DragonLib:Start(GuiConfig)
    ...
    GuiConfig.Name = GuiConfig.Name or "DragonToro Hub"
    ...
    GuiConfig["Logo Info"] = GuiConfig["Logo Info"] or "https://www.roblox.com/headshot-thumbnail/image?userId=".. game:GetService("Players").LocalPlayer.UserId .."&width=420&height=420&format=png"
     GuiConfig["Name Info"] = GuiConfig["Name Info"] or "Executor " .. identifyexecutor()
    ...
    function Tabs:MakeTab(NameTab)
        ...
        function Sections:Section(SectionConfig)
            ...
            function Items:Label(LabelConfig)
                ...
                LabelConfig.Content = LabelConfig.Content or ""
                local LabelFunc = {}
                ...
                Label.BackgroundColor3 = Color3.fromRGB(42.000001296401024, 42.000001296401024, 42.000001296401024)
                Label.BorderColor3 = Color3.fromRGB(0, 0, 0)
                Label.BorderSizePixel = 0
                Label.LayoutOrder = CountItem
                Label.Size = UDim2.new(1, -13, 0, 44)
                Label.Name = "Label"
                Label.Parent = ScrollLayer1

                UICorner120.CornerRadius = UDim.new(0, 3)
                UICorner120.Parent = Label

                LabelContent.Font = Enum.Font.GothamBold
                LabelContent.LineHeight = 0.8999999761581421
                LabelContent.Text = LabelConfig.Content
                LabelContent.TextColor3 = Color3.fromRGB(230.00000149011612, 230.00000149011612, 230.00000149011612)
                ...
                LabelContent.BackgroundTransparency = 0.9990000128746033
                LabelContent.BorderColor3 = Color3.fromRGB(0, 0, 0)
                LabelContent.BorderSizePixel = 0
                LabelContent.Position = UDim2.new(0, 10, 0, 22)
                LabelContent.Size = UDim2.new(1, -70, 0, 11)
                LabelContent.Name = "LabelContent"
                LabelContent.Parent = Label

                if LabelContent.Text == "" then
                    Label.Size = UDim2.new(1, -8, 0, 33)
                else
                    LabelContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
                        LabelContent.TextWrapped = false
                        LabelContent.Size = UDim2.new(1, -70, 0, 11 + (11 * (LabelContent.TextBounds.X // LabelContent.AbsoluteSize.X)))
                        Label.Size = UDim2.new(1, -8, 0, LabelContent.AbsoluteSize.Y + 33)
                ...
                LabelTitle.BackgroundTransparency = 0.9990000128746033
                LabelTitle.BorderColor3 = Color3.fromRGB(0, 0, 0)
                LabelTitle.BorderSizePixel = 0
                LabelTitle.Position = UDim2.new(0, 100, 0, 10)
                ...
                function LabelFunc:Set(Value)
                    local Value = Value or {}
                    Value.Title = Value.Title or LabelTitle.Text
                    Value.Content = Value.Content or LabelContent.Text
